  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-gradient-to-b from-[#001E60] via-[#0b1b3a] to-[#F5F7FB] font-sans text-slate-800 px-4 py-6">
      ...
      <div className="flex flex-col items-center">
        <img src="aces-logo.png" alt="ACES Logo" className="h-14 w-auto mb-4" />
      ...
      {/* Footer */}
      <p className="text-xs text-slate-200 text-center mt-6">
        Powered by <span className="font-semibold text-white">ACES</span>
      </p>
    </div>
  );
}
